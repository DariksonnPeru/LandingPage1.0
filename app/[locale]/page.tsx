...
<section id="impacto" className="impact-band">
  ...
  <style>{`
    /* Fondo acorde a tu paleta (mezcla del accent con el fg) */
    .impact-band{
    ...
    /* Contenedor full-bleed pero con respiración vertical */
    .impact-inner{
      max-width: 100%;
      margin: 0 auto;
      padding: 28px 18px;
    ...
    @media (max-width: 600px){
      ...
      .impact-item{ grid-template-columns: auto 1fr }
    }
  `}</style>
</section>
...
<section id="servicios" className="section services-band" style={{ scrollMarginTop: 96, paddingTop: 28, paddingBottom: 28 }}>
  ...
  <style>{`
    ...
    /* Contenido centrado dentro de la banda */
    .services-inner{
      max-width: 1320px;
      margin: 0 auto;
      display: grid;
    ...
    <div style={{ display: "grid", gap: 8 }}>
      {[
        ...
        },
        {
          ...
          a: "Sí. Desarrollamos planos arquitectónicos, estructurales e interiores, además de visualizaciones 3D para comprender mejor el proyecto."
        },
        {
