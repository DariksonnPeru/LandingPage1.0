...
export default function Footer() {
  // Renderizado en el servidor: estable y sin discrepancias de hidratación
  const year = new Date().getFullYear();

  // Contacto (constantes)
  const PHONE_MAIN = "+51973167892";
  const PHONE_ALT = "+51936764188";
  const IG_URL =
    "https://www.instagram.com/darikson.arq.constr?igsh=MWw0NG01b2NhcG41&utm_source=qr";
  ...
  return (
    ...
    >
      {/* Top: solo marca (SIN botón WhatsApp arriba) */}
      <div className="container footer-top">
        <div className="brand">
          <Link
            href="/"
            aria-label="Inicio — Servicios Generales Darikson"
            className="logo"
          >
            <Image
              src="/logo1.0.png"
              alt="Servicios Generales Darikson"
              width={44}
              height={44}
              sizes="44px"
              priority
      ...
      <div className="container footer-grid">
        <nav aria-label="Servicios" className="col">
          ...
          <ul className="links">
            ...
            <li>
              <Link href="/arquitectura#acabados">Acabados</Link>
            </li>
          </ul>
        </nav>
        ...
        <div className="col" aria-label="Contacto">
          ...
          <ul className="links">
            ...
            <li>
              <a href={`tel:${PHONE_MAIN}`} aria-label="Llamar al +51 973 167 892">
                973 167 892
              </a>
            </li>
            <li>
              <a href={`tel:${PHONE_ALT}`} aria-label="Llamar al +51 936 764 188">
                936 764 188
              </a>
            </li>
      ...
      <div className="container footer-bottom">
        <span className="muted">
          © {year} Servicios Generales Darikson. Todos los derechos reservados.
        </span>
      </div>
      ...
      <style>{`
        ...
        .brand-name{font-size:1.1rem;letter-spacing:-.01em;color:var(--fg);white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
